...
const SignUp = () => {
    ...
    const handleSignUp = async () => {
        const djServer = 'http://172.30.1.43:8000/accounts/dj-rest-auth/registration/';
        ...
        const csrfResponse = await axios.get('http://172.30.1.43:8000/accounts/get-csrf-token/');
